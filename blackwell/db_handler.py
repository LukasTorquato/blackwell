import chromadb
from blackwell.utils import messages_to_json, json_to_messages, get_available_docs
from blackwell.document_processer import build_retriever
from blackwell.config import embeddings_model
...
class ChromaDBHandler:
    ...
    def add_document(self, file_path: str) -> bool:
        ...
        try:
            ...
            from blackwell.document_processer import load_documents, process_documents
